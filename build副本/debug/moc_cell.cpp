...
#include "../../ChineseChessBattle/cell.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCellENDCLASS_t qt_meta_stringdata_CLASSCellENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 7),  // "isclick"
        QT_MOC_LITERAL(13, 0),  // ""
        QT_MOC_LITERAL(14, 1),  // "x"
        QT_MOC_LITERAL(16, 1),  // "y"
        QT_MOC_LITERAL(18, 4),  // "fade"
        QT_MOC_LITERAL(23, 7)   // "onclick"
    },
    "Cell",
    "isclick",
    "",
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->isclick((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Cell::isclick; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Cell::isclick(int _t1, int _t2)
{
